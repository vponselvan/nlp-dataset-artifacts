#!/bin/bash
# Train model with 90% SQuAD + 10% AddSent

set -e

echo "=========================================="
echo "Adversarial Fine-Tuning (90-10 Split)"
echo "=========================================="
echo ""
...
echo "Configuration:"
echo "  Training data: 90% SQuAD + 10% AddSent"
...
echo "Step 1: Preparing mixed training dataset (90-10)..."
