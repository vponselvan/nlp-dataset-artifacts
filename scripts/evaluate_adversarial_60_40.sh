#!/bin/bash
# Evaluate 60-40 model

set -e

echo "=========================================="
echo "Evaluating Model (60-40 Split)"
echo "=========================================="
echo ""

MODEL_DIR="./trained_model_adversarial_60_40"
ADDSENT_PATH="./data/addsent_adversarial.jsonl"

# Check if model exists
if [ ! -d "$MODEL_DIR" ]; then
    echo "❌ Error: Model not found at $MODEL_DIR"
    echo "Please run train_adversarial_60_40.sh first"
    exit 1
fi
...
EVAL_DIR="./evaluation/adversarial_60_40"
