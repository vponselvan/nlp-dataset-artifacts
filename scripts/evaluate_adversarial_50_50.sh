#!/bin/bash
# Evaluate 50-50 model

set -e

echo "=========================================="
echo "Evaluating Model (50-50 Split)"
echo "=========================================="
echo ""

MODEL_DIR="./trained_model_adversarial_50_50"
ADDSENT_PATH="./data/addsent_eval.jsonl"

# Check if model exists
if [ ! -d "$MODEL_DIR" ]; then
    echo "❌ Error: Model not found at $MODEL_DIR"
    echo "Please run train_adversarial_50_50.sh first"
    exit 1
fi
...
EVAL_DIR="./evaluation/adversarial_50_50"
